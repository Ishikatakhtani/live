...
const ServiceForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // save to localStorage (later connect to backend like products)
    const existingServices = JSON.parse(localStorage.getItem("allServices")) || [];
    existingServices.push(newService);
    localStorage.setItem("allServices", JSON.stringify(existingServices));
    localStorage.setItem("servicesStep", "completed");
  ...
  return (
    <div className="p-4" style={{ maxWidth: '1200px', width: '100%', margin: '0 auto', backgroundColor: '#fff' }}>
      <h2 className="fw-bold mb-4 text-primary">➕ Add New Service</h2>
      <Form onSubmit={handleSubmit}>
        {/* General Info */}
        <h5 className="fw-bold mb-3">General Info</h5>
        <Row>
          <Col md={6}>
        ...
        {/* Pricing */}
        <h5 className="fw-bold mt-4 mb-3">Pricing</h5>
        <Row>
          <Col md={6}>
            <Form.Group className="mb-3">
              <Form.Label>Rate *</Form.Label>
        ...
        {/* Media */}
        <h5 className="fw-bold mt-4 mb-3">Media</h5>
        <Form.Group className="mb-4">
          ...
          <Form.Text className="text-muted">
            Recommended size: 1000×1248px
          </Form.Text>
        </Form.Group>

        {/* Variants */}
        <h5 className="fw-bold mt-4 mb-3">Variants</h5>
        <Row className="align-items-end mb-3">
          <Col md={4}>
            <Form.Control
              value={variantName}
          ...
          <Col md={6}>
            <Form.Control
              value={variantValues}
              onChange={(e) => setVariantValues(e.target.value)}
              placeholder="Values (e.g., Basic, Premium)"
            />
          </Col>
          <Col md={2}>
        ...
        {/* Add-ons */}
        <h5 className="fw-bold mt-4 mb-3">Add-ons</h5>
        {addons.map((a, i) => (
          <div
            key={i}
        ...
        <Row className="align-items-end mb-3">
          ...
          <Col md={2}>
            <Button variant="secondary" onClick={addAddon}>
              Add
            </Button>
          </Col>
        </Row>
